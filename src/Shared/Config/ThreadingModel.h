#ifndef ORIGIN_THREADINGMODEL_H
#define ORIGIN_THREADINGMODEL_H
...
template<class T, class MUTEX> MUTEX Origin::ClassLevelLockable<T, MUTEX>::si_mtx;

#define INSTANTIATE_CLASS_MUTEX(CTYPE, MUTEX) \
    template class Origin::ClassLevelLockable<CTYPE, MUTEX>
