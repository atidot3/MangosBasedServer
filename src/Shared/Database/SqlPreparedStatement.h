...
public:
	...
	// getters
	bool toBool() const { ORIGIN_ASSERT(m_type == FIELD_BOOL); return !!m_binaryData.ui8; }
	uint8 toUint8() const { ORIGIN_ASSERT(m_type == FIELD_UI8); return m_binaryData.ui8; }
	int8 toInt8() const { ORIGIN_ASSERT(m_type == FIELD_I8); return m_binaryData.i8; }
	uint16 toUint16() const { ORIGIN_ASSERT(m_type == FIELD_UI16); return m_binaryData.ui16; }
	int16 toInt16() const { ORIGIN_ASSERT(m_type == FIELD_I16); return m_binaryData.i16; }
	uint32 toUint32() const { ORIGIN_ASSERT(m_type == FIELD_UI32); return m_binaryData.ui32; }
	int32 toInt32() const { ORIGIN_ASSERT(m_type == FIELD_I32); return m_binaryData.i32; }
	uint64 toUint64() const { ORIGIN_ASSERT(m_type == FIELD_UI64); return m_binaryData.ui64; }
	int64 toInt64() const { ORIGIN_ASSERT(m_type == FIELD_I64); return m_binaryData.i64; }
	float toFloat() const { ORIGIN_ASSERT(m_type == FIELD_FLOAT); return m_binaryData.f; }
	double toDouble() const { ORIGIN_ASSERT(m_type == FIELD_DOUBLE); return m_binaryData.d; }
	const char* toStr() const { ORIGIN_ASSERT(m_type == FIELD_STRING); return m_szStringData.c_str(); }
