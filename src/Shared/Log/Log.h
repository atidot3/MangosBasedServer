#ifndef ORIGINSERVER_LOG_H
#define ORIGINSERVER_LOG_H
...
class Log : public Origin::Singleton<Log, Origin::ClassLevelLockable<Log, std::mutex> >
{
	friend class Origin::OperatorNew<Log>;
	Log();
...
#define sLog Origin::Singleton<Log>::Instance()
