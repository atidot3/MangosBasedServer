...
//                                                  W  P                 M
static const uint8 classToIndex[MAX_CLASSES] = { 1 };
...
enum Powers
{
	POWER_ENERGY = 0,            // UNIT_FIELD_POWER1
	POWER_MANA = 1,
...
#define EXPECTED_ORIGIN_CLIENT_BUILD        {1499, 0}
