...
enum eConfigFloatValues
{
	...
	CONFIG_FLOAT_RATE_POWER_KI_INCOME,
	CONFIG_FLOAT_RATE_POWER_KI_LOSS,
...
public:
	...
	void SendZoneUnderAttackMessage(uint32 zoneId);
...
#define sWorld Origin::Singleton<World>::Instance()
#endif
/// @}
